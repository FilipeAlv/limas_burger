...
class Produto {
  ...
  Produto(this.id, this.nome, this.imagem, this.valor, this.status,
      this.ingredientes, this.promocao);
  ...
  static _fromJson(List _result) async {
    if (_result != null) {
      ...
      _result.forEach((item) async {
        ...
        Produto p = Produto(_id, _nome, _imagem, double.parse(_valor), _status,
            ingredientes, promocao);
        _produtos.add(p);
      });
